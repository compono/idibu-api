<p class="rtejustify" style=""><b>Interacting with our API using .NET is easy - all you need you use is just two code functions: one for exchanging POST data for services like&nbsp;<a href="https://github.com/oneworldmarket/idibu-api/tree/master/api-v3">Adpost&nbsp;XML v3</a>&nbsp;and one for GET requests, for services that don&#39;t require any data besides the URL.</b></p>
<p class="rtejustify" style="">Here&#39;s an example code for both of them, including usage examples, for both C# and Visual Basic .NET. If you need further help with .NET integration or have any questions regarding the code, feel free to ask us in comments. All the functions below are<strong>&nbsp;</strong>static<strong>,</strong> which means they must be placed in a static class - preferably&nbsp;one with a &quot;public&quot; attribute. That makes the code even easier to use, as you don&#39;t need to create any instances of your API interaction class and the functions provided are always ready to use.</p>
